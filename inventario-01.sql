...
CREATE TABLE FABRICANTE 
	(
		COD_FAB				INTEGER   			PRIMARY KEY ON DELETE CASCADE,
...
CREATE TABLE SOFTWARE
  (
    COD_SOFT      INTEGER          PRIMARY KEY ON DELETE CASCADE,
...
CREATE TABLE EQUIPAMENTO
  (
    NUM_PATRI     INTEGER         PRIMARY KEY ON DELETE CASCADE,
...
CREATE TABLE ITENS_HARDWARE_INSTALADO
  (
    NUM_PATRI_COMPUTADOR    INTEGER REFERENCES COMPUTADOR,
    NUM_PATRI_PERIFERICO    INTEGER REFERENCES PERIFERICO,
...
CREATE TABLE ITENS_SOFTWARE_INSTALADO
  (
    COD_SOFT    INTEGER   REFERENCES SOFTWARE,
    NUM_PATRI_COMPUTADOR  INTEGER REFERENCES COMPUTADOR,
